...
class TrajectoryClient:
    ...
    def send_joint_trajectory(self):
        ...
        position_list = [[-3.14, -3.14, 0, 0, 0, 0]]
        # position_list = [[0, -1.57, -1.57, 0, 0, 0]]
        position_list.append([-3.14,   -1.57,  -1.57,  -1,     1,  1])
        position_list.append([-2.8,     -1.2,   -1.2,    0,     0,  0])
        position_list.append([-2.5,     -1,     -0.8,   -1,     -1, -1])
        position_list.append([-2.2,      -0.7,   -1.57,  -1,     -2,  1])
        position_list.append([-1.9,      -0.5,   -1.2,    0,     -1,  1])
        position_list.append([-1.6,      -0.2,   -0.8,   -1,     0,  -1])
        position_list.append([-1.3,       0,     -1.57,  -1,     1,  -2])
        position_list.append([-1.0,      -0.25,  -1.2,    0,     2,  -1])
        position_list.append([-1.3,     -0.5,   -0.8,   -1,     1, -1])
        position_list.append([-1.6,     -0.2,   -1.57,  -1,     0,  1])
        position_list.append([-1.9,     -0.57,  -1.2,    0,     -1,  0])
        position_list.append([-2.2,     -0.71,  -0.8,   -1,     0, -1])
        position_list.append([-1.185,   -0.1,   -1.57,  -1,     1,  1])
        position_list.append([-1.4,     -1.1,   -1.2,    0,     0,  0])
        position_list.append([-1.9,    -1.5,   -0.8,   -1,     1, -1])
        position_list.append([-2.2,     -1.9,   -0.57,  -1,     1,  1])
        position_list.append([-1.9,     -2.3,   -0.2,    0,     0,  0])
        position_list.append([-1.6,   -3.14,   0,      0,     0,  0])
        position_list.append([-1.3,     -1.1,   -1.2,    0,     0,  0])
        position_list.append([-1,    -1.5,   -0.8,   -1,     1, -1])
        position_list.append([-0.7,     -1.9,   -0.57,  -1,     1,  1])
        position_list.append([-0.4,     -2.3,   -0.2,    0,     0,  0])
        position_list.append([-0.9,   -3.14,   0,      0,     0,  0])
        position_list.append([-1.4,     -1.9,   -0.57,  -1,     1,  1])
        position_list.append([-1.9,     -2.3,   -0.2,    0,     0,  0])
        position_list.append([-3.14,   -3.14,   0,      0,     0,  0])

        duration_list = [3, 6, 9, 12, 15, 18, 21, 24, 27, 30, 33, 36, 39, 42, 45, 48, 51, 54, 57, 60, 63, 66, 69, 72, 75, 78, 81, 84]
        # for j in range(1000):
        #     position_list.append([-0.785+0.001*j, -1.57, -1.57, 0, 0, 0])
        #     # position_list.append([0+0.001*j, -1.57, -1.57, 0, 0, 0])
        #     duration_list.append(3+0.01*j)
        # print(duration_list)
