...
echo_and_run cd "/home/xhnfly/X_ROS/src/X_UR/ee_ur5e/gripper/robotiq_2f_gripper_control"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/xhnfly/X_ROS/src/X_UR/ee_ur5e/gripper/robotiq_2f_gripper_control/setup.py" \
     \
    build --build-base "/home/xhnfly/X_ROS/build/X_UR/ee_ur5e/gripper/robotiq_2f_gripper_control" \
    install \
    --root="${DESTDIR-/}" \
