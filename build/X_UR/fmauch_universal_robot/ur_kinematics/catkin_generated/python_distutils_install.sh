...
echo_and_run cd "/home/xhnfly/X_ROS/src/X_UR/fmauch_universal_robot/ur_kinematics"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/xhnfly/X_ROS/src/X_UR/fmauch_universal_robot/ur_kinematics/setup.py" \
     \
    build --build-base "/home/xhnfly/X_ROS/build/X_UR/fmauch_universal_robot/ur_kinematics" \
    install \
    --root="${DESTDIR-/}" \
